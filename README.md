...
One can give the energy a value of 0, in this case tau-energies are generated (randomly) uniformly in log-space in the range E=1e15 eV and E=1e21. Only in this case the tau-neutrino energies are stored as the last column in the output file. 
